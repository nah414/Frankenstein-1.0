#!/usr/bin/env python3
"""
FRANKENSTEIN 1.0 - Intel oneAPI Adapter
ONEAPI classical compute platform.
Requires: pip install dpnp
"""
...
class IntelAdapter(ProviderAdapter):
    def __init__(self, credentials: Optional[Dict] = None):
        super().__init__("intel_oneapi", ProviderCategory.CLASSICAL_ACCELERATOR, credentials)
        self._client = None
        self._jobs = {}
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            self._backends = [BackendInfo(
                ...
                backend_type="cpu",
                compute_units=1,
                architecture=ClassicalArchitecture.ONEAPI,
                is_available=True
            )]
            ...
            self.error_message = "dpnp not installed. Run: pip install dpnp"
            return False

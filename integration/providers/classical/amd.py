#!/usr/bin/env python3
"""
FRANKENSTEIN 1.0 - AMD ROCm Adapter
ROCM classical compute platform.
...
class AmdAdapter(ProviderAdapter):
    def __init__(self, credentials: Optional[Dict] = None):
        super().__init__("amd_rocm", ProviderCategory.CLASSICAL_GPU, credentials)
        self._client = None
        self._jobs = {}
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            self._backends = [BackendInfo(
                ...
                backend_type="gpu",
                compute_units=1,
                architecture=ClassicalArchitecture.ROCM,
                is_available=True
            )]
            ...
            self.error_message = "torch not installed. Run: pip install torch"
            return False
